...
create table if not exists public.app_settings (
  ...
  smtp_user text,
  smtp_pass text,
  smtp_from_email text default 'hello@techneyo.com',
  smtp_from_name text default 'Techneyo Solutions',
  email_provider text default 'brevo' check (email_provider in ('brevo', 'emailjs', 'elasticemail')),
  email_api_key text,
...
create table if not exists public.offers (
  ...
  booking_amount_type text default 'fixed' check (booking_amount_type in ('fixed', 'full', 'percentage')),
