...
export const servicePages: ServicePage[] = [
  {
    ...
    keywords: "website development company India, business website development India, affordable web design India, custom web design agency, responsive website development, SEO friendly website India, lead generation website India",
    h1: "Website Development Services for Businesses Across India",
    intro: "A business website should do more than look modern. It should explain what you do, make your business easy to trust, help customers contact you quickly, and support future SEO, CRM, WhatsApp, and automation workflows. Techneyo Solutions provides website development services in India for local businesses, startups, shops, consultants, clinics, institutes, manufacturers, and growing companies. We focus on business website development services across India, SEO friendly website development, website development for lead generation, and website with WhatsApp integration for business. Whether you need an affordable website development for small business in India package or a more advanced website with CRM integration, the goal is to turn your online presence into a useful business asset.",
    ...
    faqs: [
      ...
      { question: "Do you provide website development for small businesses?", answer: "Yes. Techneyo Solutions builds affordable website development for small businesses across India, including websites for shops, consultants, clinics, institutes, service providers, and startups." },
  ...
  },
  {
    ...
    seoTitle: "Business Website Design Services in India | Techneyo Solutions",
    metaDescription: "Business website design services for companies in India that need clear service pages, mobile-friendly layouts, enquiry CTAs, SEO structure, and trusted digital presence.",
    keywords: "business website design India, professional web design services India, company website design India, service page design, mobile friendly business website, conversion focused web design India",
    h1: "Business website design that makes your company easier to trust and contact.",
    intro: "Business website design is about clarity, credibility, and conversion. A good business website should help visitors understand your services, see why your company is relevant, and contact you without friction. Techneyo Solutions designs business websites for service providers, local businesses, consultants, institutes, clinics, manufacturers, and growing teams across India. We structure pages around service clarity, customer questions, location relevance, trust signals, and strong contact paths. The result is a practical website that supports sales conversations, Google visibility, and professional brand identity.",
  ...
  },
  {
    ...
    keywords: "custom CRM development company India, lead management CRM India, business CRM software, custom CRM software developer India, sales lead tracking CRM India, website CRM integration",
    h1: "CRM Development for Customer Enquiries and Lead Tracking",
    intro: "Many businesses receive enquiries from calls, WhatsApp, forms, ads, and referrals, but lose track of follow-ups. A practical CRM helps centralize leads, customer details, enquiry source, status, notes, and next actions. Techneyo Solutions is a CRM development company in India for businesses that need custom CRM software development across India, CRM for managing customer enquiries, lead management CRM for small business, and website with CRM integration. Instead of forcing every business into the same generic software, we plan CRM workflows around how your team captures, qualifies, follows up, and closes enquiries.",
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Do you provide services across India?", answer: "Yes. Techneyo Solutions works with businesses across India." }
    ],
  },
  {
    ...
    keywords: "WhatsApp automation consultation India, WhatsApp business chatbot India, website WhatsApp integration, WhatsApp CRM workflow automation, lead capture WhatsApp API India",
    h1: "WhatsApp Automation for Business Enquiries and Follow-Ups",
    intro: "WhatsApp is a primary communication channel for many businesses. Customers often prefer quick chats instead of long forms. Techneyo Solutions helps businesses plan WhatsApp automation for business across India, WhatsApp chatbot for business enquiries, website with WhatsApp integration for business, WhatsApp CRM integration, and follow-up workflows. We do not make false platform claims or promise verification. We focus on clean, compliant, practical communication workflows that make it easier for customers to contact your business.",
  ...
  },
  {
    ...
    metaDescription: "Improve your business visibility with SEO-ready websites, local SEO, Google Business Profile optimization, content structure, and digital presence setup in India.",
    keywords: "SEO services India, digital presence setup India, local SEO services India, Google Business Profile optimization, technical SEO audit, SEO friendly website setup India",
    h1: "SEO and Digital Presence Services for Small Businesses in India",
    ...
    forWhom: ["Businesses in India", "Companies launching a new website", "Businesses with weak Google visibility", "Service providers planning long-term content growth"],
    ...
    faqs: [
      ...
      { question: "Can you help businesses in India?", answer: "Yes. Techneyo Solutions serves businesses across India." },
  ...
  },
  {
    ...
    metaDescription: "Build custom web-based software, SaaS platforms, dashboards, automation tools, and business applications with Techneyo Solutions in India.",
    keywords: "custom software development company India, web-based software solutions India, SaaS product development company, custom business web application developer, internal tool builder India",
    h1: "Custom Software Development for Business Operations in India",
    intro: "When a business outgrows spreadsheets, manual tracking, or disconnected tools, custom web-based software can create a cleaner workflow. Techneyo Solutions is a custom software development company in India serving businesses across India with custom web application development for business, SaaS development support, business software development, web-based software solutions, CRM, dashboards, booking flows, customer portals, reporting, and internal tools. We begin with the business problem, not the technology buzzword, then build a system that supports daily work and future growth.",
